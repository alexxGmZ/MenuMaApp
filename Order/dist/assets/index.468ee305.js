...
function getLocalIpAddress() {
  return new Promise((resolve, reject) => {
    ...
    rtcPeerConnection.createOffer().then((offer) => rtcPeerConnection.setLocalDescription(offer)).catch((error) => reject(error));
...
getLocalIpAddress().then((ipAddress) => document.getElementById("device_ip_address").textContent = ipAddress);
